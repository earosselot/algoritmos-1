...
TEST(costoSubsidioMejoraTEST, TodasLasCasas) {
    eph_h th = {
            {15726, 2018, 3, 336630, 646391, 1, 40, 1, 1, 3, 1, 2},     // propia,no alcanzan = V
    ...
    EXPECT_EQ(3 * monto, res);
}

/******************************************************************************
TEST 4- Caso Border
Otro caso puede ser que todos sean propietarios pero ninguna tenga casachica.
*******************************************************************************/

TEST(costoSubsidioMejoraTEST, TodosPropNingunoCasChica) {
    eph_h th = {
            {15726, 2018, 3, 336630, 646391, 1, 40, 1, 1, 3, 4, 2},
            {188,   2018, 3, 325187, 635309, 1, 40, 0, 1, 3, 4, 2},
            {11867, 2018, 3, 320329, 630940, 1, 43, 1, 1, 3, 4, 2},
            {14914, 2018, 3, 321889, 631412, 1, 43, 0, 2, 3, 4, 2},
    };
...
/******************************************************************************
TEST S- Caso Border
Por ultimo veamos que pasa para los casos de que tenga casachica pero ninguno sea
propietario.
*******************************************************************************/


TEST(costoSubsidioMejoraTEST, NingunoPropTodosCasChica) {
    eph_h th = {
            {15726, 2018, 3, 336630, 646391, 2, 40, 1, 1, 3, 1, 2},
            {188,   2018, 3, 325187, 635309, 2, 40, 0, 1, 3, 1, 2},
            {14914, 2018, 3, 321889, 631412, 2, 43, 0, 2, 3, 1, 2},
    };
